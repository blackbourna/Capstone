...
GameMenu=function(director) {
	...
	this.showMenu = function() {
		...
		var helpButton = new lime.GlossyButton('Instructions').setPosition(500, 600).setSize(500, 50);
		goog.events.listen(helpButton, ['mousedown','touchstart'], function(e) {
			
		});
		scene.appendChild(helpButton);

		var highscoreButton = new lime.GlossyButton('High Scores').setPosition(500, 700).setSize(500, 50);
